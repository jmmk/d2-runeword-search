...
runewords =
  ...
  , { name = "Breath of the Dying"
    ...
    , itemTypes = [ Bow, Crossbow, Axe, Sword, Polearm, Mace, Spear, Staff ]
    , ladderOnly = False
    , patch = OneTen
    , clvl = 69
    }
  , { name = "Call to Arms"
    ...
    , itemTypes = [ Axe, Sword, Mace, Polearm, Spear, Scepter, Staff, Bow, Crossbow ]
    , ladderOnly = False
    , patch = OneTen
    , clvl = 57
    }
  ...
  , { name = "Eternity"
    ...
    , itemTypes = [ Axe, Sword, Mace, Polearm, Spear, Scepter, Staff ]
    , ladderOnly = False
    , patch = OneTen
    , clvl = 63
    }
  ...
  , { name = "Fortitude"
    ...
    , itemTypes = [ Armor, Axe, Sword, Mace, Polearm, Spear, Scepter, Staff, Bow, Crossbow, Hammer ]
    , ladderOnly = True
    , patch = OneTen
    , clvl = 59
    }
  , { name = "Fury"
    ...
    , itemTypes = [ Axe, Sword, Mace, Polearm, Spear, Scepter, Staff, Club, Hammer, Claw ]
    , ladderOnly = False
    , patch = OneNine
    , clvl = 65
    }
  ...
  , { name = "Hand of Justice"
    ...
    , itemTypes = [ Axe, Sword, Mace, Polearm, Spear, Scepter, Staff, Bow, Crossbow, Hammer ]
    , ladderOnly = False
    , patch = OneTen
    , clvl = 67
    }
  ...
  , { name = "Phoenix"
    ...
    , itemTypes = [ Axe, Sword, Mace, Polearm, Spear, Scepter, Staff, Bow, Crossbow, Hammer, Shield ]
    , ladderOnly = True
    , patch = OneTen
    , clvl = 65
    }
  ...
  , { name = "Venom"
    ...
    , itemTypes = [ Axe, Sword, Mace, Polearm, Spear, Scepter, Staff, Bow, Crossbow, Hammer, Claw, Club ]
    , ladderOnly = False
    , patch = OneNine
    , clvl = 49
    }

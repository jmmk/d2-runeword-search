...
Elm.Runewords.make = function (_elm) {
   "use strict";
   _elm.Runewords = _elm.Runewords || {};
   if (_elm.Runewords.values) return _elm.Runewords.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var Runeword = F8(function (a,b,c,d,e,f,g,h) {
      return {name: a
             ,runes: b
             ,itemTypes: c
             ,sockets: d
   ...
   var Spear = {ctor: "Spear"};
   var Claw = {ctor: "Claw"};
   var Polearm = {ctor: "Polearm"};
   var Wand = {ctor: "Wand"};
   var Crossbow = {ctor: "Crossbow"};
   var Bow = {ctor: "Bow"};
   var Staff = {ctor: "Staff"};
   var Sword = {ctor: "Sword"};
   var Mace = {ctor: "Mace"};
   var Scepter = {ctor: "Scepter"};
   var Hammer = {ctor: "Hammer"};
   var Axe = {ctor: "Axe"};
   var Club = {ctor: "Club"};
   var Helm = {ctor: "Helm"};
   var Shield = {ctor: "Shield"};
   var Armor = {ctor: "Armor"};
   var Zod = {ctor: "Zod"};
   var Cham = {ctor: "Cham"};
   var Jah = {ctor: "Jah"};
   var Ber = {ctor: "Ber"};
   ...
   var Eld = {ctor: "Eld"};
   var El = {ctor: "El"};
   var runewords = _U.list([{name: "Ancient\'s Pledge"
                            ,runes: _U.list([Ral,Ort,Tal])
                            ,sockets: 3
                            ,properties: _U.list(["+50% Enhanced Defense"
                                                 ,"Cold Resist +43%"
                                                 ,"Lightning Resist +48%"
                                                 ,"Fire Resist +48%"
                                                 ,"Poison Resist +48%"
                                                 ,"10% Damage Taken Goes to Mana"])
                            ,itemTypes: _U.list([Shield])
                            ,ladderOnly: false
                            ,patch: $Patch.OneNine
                            ,clvl: 21}
                           ,{name: "Beast"
                            ...
                            ,sockets: 5
                            ,properties: _U.list(["Level 9 Fanaticism Aura When Equipped"
                            ...
                            ,itemTypes: _U.list([Axe,Hammer,Scepter])
                            ,ladderOnly: false
                            ,patch: $Patch.OneTen
                            ,clvl: 63}
                           ,{name: "Black"
                            ...
                            ,sockets: 3
                            ,properties: _U.list(["+15% Increased Attack Speed"
                                                 ,"+120% Enhanced Damage"
                            ...
                            ,itemTypes: _U.list([Club,Hammer,Mace])
                            ,ladderOnly: false
                            ,patch: $Patch.OneNine
                            ,clvl: 35}
                           ,{name: "Bone"
                            ...
                            ,sockets: 3
                            ,properties: _U.list(["15% Chance To Cast level 10 Bone Armor When Struck"
                                                 ,"15% Chance To Cast level 10 Bone Spear On Striking"
                                                 ,"+2 To Necromancer Skill Levels"
                                                 ,"+100-150 To Mana (varies) "
                                                 ,"All Resistances +30"
                                                 ,"Damage Reduced By 7"])
                            ,itemTypes: _U.list([Armor])
                            ,ladderOnly: false
                           ...
                           ,{name: "Bramble"
                            ...
                            ,sockets: 4
                            ,properties: _U.list(["Level 15-21 Thorns Aura When Equipped (varies)"
                           ...
                           ,{name: "Brand"
                            ...
                            ,sockets: 4
                            ,properties: _U.list(["35% Chance To Cast Level 14 Amplify Damage When Struck"
                                                 ...
                                                 ,"Prevent Monster Heal"
                                                 ,"Knockback"])
                            ,itemTypes: _U.list([Bow,Crossbow])
                            ,ladderOnly: true
                            ,patch: $Patch.OneTen
                            ,clvl: 65}
                           ,{name: "Breath of the Dying"
                            ...
                            ,sockets: 6
                            ,properties: _U.list(["50% Chance To Cast Level 20 Poison Nova When You Kill An Enemy"
                                                 ,"Indestructible"
                           ...
                           ,{name: "Call to Arms"
                            ...
                            ,sockets: 5
                            ,properties: _U.list(["+1 To All Skills"
                                                 ,"+40% Increased Attack Speed"
                           ...
                           ,{name: "Chains of Honor"
                            ...
                            ,sockets: 4
                            ,properties: _U.list(["+2 To All Skills"
                           ...
                           ,{name: "Chaos"
                            ...
                            ,sockets: 3
                            ,properties: _U.list(["9% Chance To Cast Level 11 Frozen Orb On Striking"
                           ...
                           ,{name: "Crescent Moon"
                            ...
                            ,sockets: 3
                            ,properties: _U.list(["10% Chance To Cast Level 17 Chain Lightning On Striking"
                            ...
                            ,itemTypes: _U.list([Axe,Polearm,Sword])
                            ,ladderOnly: false
                            ,patch: $Patch.OneTen
                            ,clvl: 47}
                           ,{name: "Death"
                            ...
                            ,sockets: 5
                            ,properties: _U.list(["Indestructible"
                           ...
                           ,{name: "Delirium"
                            ...
                            ,sockets: 3
                            ,properties: _U.list(["1% Chance To Cast lvl 50 Delirium When Struck"
                           ...
                           ,{name: "Destruction"
                            ...
                            ,sockets: 5
                            ,properties: _U.list(["23% Chance To Cast Level 12 Volcano On Striking"
                                                 ...
                                                 ,"Prevent Monster Heal"
                                                 ,"+10 To Dexterity"])
                            ,itemTypes: _U.list([Polearm,Sword])
                            ,ladderOnly: true
                            ,patch: $Patch.OneTen
                            ,clvl: 65}
                           ,{name: "Doom"
                            ...
                            ,sockets: 5
                            ,properties: _U.list(["5% Chance To Cast Level 18 Volcano On Striking"
                                                 ...
                                                 ,"Freezes Target +3"
                                                 ,"Requirements -20%"])
                            ,itemTypes: _U.list([Axe,Hammer,Polearm])
                            ,ladderOnly: false
                            ,patch: $Patch.OneTen
                            ,clvl: 67}
                           ,{name: "Dragon"
                            ...
                            ,properties: _U.list(["Both"
                                                 ...
                                                 ,"Shields"
                                                 ,"+50 To Mana"])
                            ,itemTypes: _U.list([Armor,Shield])
                            ,ladderOnly: true
                            ,patch: $Patch.OneTen
                            ,clvl: 61}
                           ,{name: "Dream"
                           ...
                           ,{name: "Duress"
                            ...
                            ,sockets: 3
                            ,properties: _U.list(["40% faster hit Recovery"
                           ...
                           ,{name: "Edge"
                            ...
                            ,sockets: 3
                            ,properties: _U.list(["Level 15 Thorns Aura When Equipped"
                           ...
                           ,{name: "Enlightenment"
                            ...
                            ,sockets: 3
                            ,properties: _U.list(["5% Chance To Cast Level 15 Blaze When Struck"
                           ...
                           ,{name: "Exile"
                            ...
                            ,sockets: 4
                            ,properties: _U.list(["15% Chance To Cast Level 5 Life Tap On Striking"
                           ...
                           ,{name: "Faith"
                            ...
                            ,sockets: 4
                            ,properties: _U.list(["Level 12-15 Fanaticism Aura When Equipped (varies)"
                           ...
                           ,{name: "Famine"
                            ...
                            ,sockets: 4
                            ,properties: _U.list(["+30% Increased Attack Speed"
                           ...
                           ,{name: "Fury"
                            ...
                            ,sockets: 3
                            ,properties: _U.list(["40% Increased Attack Speed"
                                                 ,"+209% Enhanced Damage"
                           ...
                           ,{name: "Gloom"
                            ...
                            ,sockets: 3
                            ,properties: _U.list(["15% Chance To Cast Level 3 Dim Vision When Struck"
                           ...
                           ,{name: "Grief"
                            ...
                            ,sockets: 5
                            ,properties: _U.list(["35% Chance To Cast Level 15 Venom On Striking"
                           ...
                           ,{name: "Hand of Justice"
                            ...
                            ,sockets: 4
                            ,properties: _U.list(["100% Chance To Cast Level 36 Blaze When You Level-Up"
                           ...
                           ,{name: "Harmony"
                            ...
                            ,sockets: 4
                            ,properties: _U.list(["Level 10 Vigor Aura When Equipped"
                           ...
                           ,{name: "Heart of the Oak"
                            ...
                            ,sockets: 4
                            ,properties: _U.list(["+3 To All Skills"
                                                 ,"+40% Faster Cast Rate"
                                                 ,"+75% Damage To Demons"
                           ...
                           ,{name: "Holy Thunder"
                            ...
                            ,sockets: 4
                            ,properties: _U.list(["+60% Enhanced Damage"
                           ...
                           ,{name: "Ice"
                            ...
                            ,sockets: 4
                            ,properties: _U.list(["100% Chance To Cast Level 40 Blizzard When You Level-up"
                           ...
                           ,{name: "Infinity"
                            ...
                            ,sockets: 4
                            ,properties: _U.list(["50% Chance To Cast Level 20 Chain Lightning When You Kill An Enemy"
                           ...
                           ,{name: "Insight"
                            ...
                            ,sockets: 4
                            ,properties: _U.list(["Level 12-17 Meditation Aura When Equipped (varies)"
                                                 ,"+35% Faster Cast Rate"
                            ...
                            ,itemTypes: _U.list([Polearm,Staff])
                            ,ladderOnly: true
                            ,patch: $Patch.OneTen
                            ,clvl: 27}
                           ,{name: "King\'s Grace"
                            ...
                            ,sockets: 3
                            ,properties: _U.list(["+100% Enhanced Damage"
                                                 ...
                                                 ,"Adds 3-14 Cold damage"
                                                 ,"7% Life stolen per hit"])
                            ,itemTypes: _U.list([Sword,Scepter])
                            ,ladderOnly: false
                            ,patch: $Patch.OneNine
                            ,clvl: 25}
                           ,{name: "Kingslayer"
                           ...
                           ,{name: "Last Wish"
                            ...
                            ,sockets: 6
                            ,properties: _U.list(["6% Chance To Cast Level 11 Fade When Struck"
                            ...
                            ,itemTypes: _U.list([Axe,Hammer,Sword])
                            ,ladderOnly: true
                            ,patch: $Patch.OneTen
                            ,clvl: 65}
                           ,{name: "Lawbringer"
                            ...
                            ,sockets: 3
                            ,properties: _U.list(["20% Chance To Cast Level 15 Decrepify On Striking"
                                                 ...
                                                 ,"+10 To Dexterity"
                                                 ,"75% Extra Gold From Monsters"])
                            ,itemTypes: _U.list([Hammer,Scepter,Sword])
                            ,ladderOnly: true
                            ,patch: $Patch.OneTen
                            ,clvl: 43}
                           ,{name: "Leaf"
                            ...
                            ,sockets: 2
                            ,properties: _U.list(["+3 to Fire Skills"
                                                 ,"Adds 5-30 Fire Damage"
                           ...
                           ,{name: "Lionheart"
                            ...
                            ,sockets: 3
                            ,properties: _U.list(["+20% Enhanced Damage"
                                                 ,"+25 To Strength"
                                                 ,"+15 To Dexterity"
                                                 ,"+20 To Vitality"
                                                 ,"+10 To Energy"
                           ...
                           ,{name: "Malice"
                            ...
                            ,sockets: 3
                            ,properties: _U.list(["+33% Enhanced Damage"
                                                 ,"+9 to Maximum Damage"
                                                 ,"-25% Target Defense"
                                                 ,"+50 to Attack Rating"
                           ...
                           ,{name: "Melody"
                            ...
                            ,sockets: 3
                            ,properties: _U.list(["+3 To Bow and Crossbow Skills (Amazon Only)"
                                                 ,"+20% Increased Attack Speed"
                                                 ,"+50% Enhanced Damage"
                           ...
                           ,{name: "Memory"
                            ...
                            ,sockets: 4
                            ,properties: _U.list(["+3 To Sorceress Skill Levels"
                                                 ,"+33% Faster Cast Rate"
                                                 ,"+9 To Minimum Damage"
                                                 ,"-25% Target Defence"
                           ...
                           ,{name: "Myth"
                            ...
                            ,sockets: 3
                            ,properties: _U.list(["3% Chance To Cast Level 1 Howl When Struck"
                           ...
                           ,{name: "Oath"
                            ...
                            ,itemTypes: _U.list([Axe,Mace,Sword])
                            ,ladderOnly: true
                            ,patch: $Patch.OneTen
                            ,clvl: 59}
                           ,{name: "Obedience"
                            ...
                            ,sockets: 5
                            ,properties: _U.list(["30% Chance To Cast Level 21 Enchant When You Kill An Enemy"
                           ...
                           ,{name: "Passion"
                            ...
                            ,sockets: 4
                            ,properties: _U.list(["+25% Increased Attack Speed"
                           ...
                           ,{name: "Peace"
                            ...
                            ,sockets: 3
                            ,properties: _U.list(["4% Chance To Cast Level 5 Slow Missiles When Struck"
                           ...
                           ,{name: "Pride"
                            ...
                            ,sockets: 4
                            ,properties: _U.list(["25% Chance To Cast Level 17 Fire Wall When Struck"
                           ...
                           ,{name: "Principle"
                            ...
                            ,sockets: 3
                            ,properties: _U.list(["100% Chance To Cast Level 5 Holy Bolt On Striking"
                           ...
                           ,{name: "Prudence"
                            ...
                            ,sockets: 2
                            ,properties: _U.list(["+25% Faster Hit Recovery"
                           ...
                           ,{name: "Radiance"
                            ...
                            ,sockets: 3
                            ,properties: _U.list(["+75% Enhanced Defense"
                           ...
                           ,{name: "Rain"
                            ...
                            ,sockets: 3
                            ,properties: _U.list(["5% Chance To Cast Level 15 Cyclone Armor When Struck"
                           ...
                           ,{name: "Rhyme"
                            ...
                            ,sockets: 2
                            ,properties: _U.list(["+40% Faster Block Rate"
                           ...
                           ,{name: "Rift"
                            ...
                            ,sockets: 4
                            ,properties: _U.list(["20% Chance To Cast Level 16 Tornado On Striking"
                                                 ...
                                                 ,"Requirements -20%"])
                            ,itemTypes: _U.list([Polearm,Scepter])
                            ,ladderOnly: true
                            ,patch: $Patch.OneTen
                            ,clvl: 53}
                           ,{name: "Sanctuary"
                            ...
                            ,sockets: 3
                            ,properties: _U.list(["+20% Faster Hit Recovery"
                           ...
                           ,{name: "Spirit"
                            ...
                            ,properties: _U.list(["Both"
                                                 ...
                                                 ,"+75 Poison Damage Over 5 Seconds"
                                                 ,"7% Life Stolen Per Hit"])
                            ,itemTypes: _U.list([Shield,Sword])
                            ,ladderOnly: true
                            ,patch: $Patch.OneTen
                            ,clvl: 25}
                           ,{name: "Splendor"
                           ...
                           ,{name: "Stealth"
                            ...
                            ,sockets: 2
                            ,properties: _U.list(["+25% Faster Run/Walk"
                           ...
                           ,{name: "Steel"
                            ...
                            ,properties: _U.list(["+25% Increased Attack Speed"
                                                 ...
                                                 ,"+2 to Mana after each Kill"
                                                 ,"+1 to Light Radius"])
                            ,itemTypes: _U.list([Sword,Axe,Mace])
                            ,ladderOnly: false
                            ,patch: $Patch.OneNine
                            ,clvl: 13}
                           ,{name: "Stone"
                            ,runes: _U.list([])
                            ,sockets: 4
                            ,properties: _U.list(["+60% Faster Hit Recovery"
                           ...
                           ,{name: "Strength"
                            ...
                            ,sockets: 2
                            ,properties: _U.list(["+35% Enhanced Damage"
                                                 ,"7% Life stolen per hit"
                           ...
                           ,{name: "Treachery"
                            ...
                            ,sockets: 3
                            ,properties: _U.list(["5% Chance To Cast Level 15 Fade When Struck"
                           ...
                           ,{name: "Venom"
                            ...
                            ,sockets: 3
                            ,properties: _U.list(["Ignore Target\'s Defense"
                           ...
                           ,{name: "Voice of Reason"
                            ...
                            ,sockets: 4
                            ,properties: _U.list(["15% Chance To Cast Level 13 Frozen Orb On Striking"
                           ...
                           ,{name: "Wealth"
                            ...
                            ,sockets: 3
                            ,properties: _U.list(["+10 to Dexterity"
                                                 ,"+2 to Mana After Each Kill"
                           ...
                           ,{name: "White"
                            ...
                            ,sockets: 2
                            ,properties: _U.list(["+3 to Poison and Bone Skills (Necromancer Only)"
                                                 ,"+20% Faster Cast Rate"
                           ...
                           ,{name: "Wind"
                            ...
                            ,sockets: 2
                            ,properties: _U.list(["10% Chance To Cast Level 9 Tornado On Striking"
                                                 ,"+20% Faster Run/Walk"
                                                 ,"+40% Increased Attack Speed"
                           ...
                           ,{name: "Wrath"
                            ...
                            ,sockets: 4
                            ,properties: _U.list(["30% Chance To Cast Level 1 Decrepify On Striking"
                           ...
                           ,{name: "Zephyr"
                            ...
                            ,sockets: 2
                            ,properties: _U.list(["7% Chance to Cast Level 1 Twister When Struck"
                                                 ,"+25% Faster Run/Walk"
...
Elm.Main.make = function (_elm) {
   ...
   _U.list([A2($Html.div,
   _U.list([$Html$Attributes.$class("hero-content")]),
   _U.list([A2($Html.div,
   _U.list([$Html$Attributes.$class("container")]),
   _U.list([A2($Html.h1,
   _U.list([$Html$Attributes.$class("title is-1")]),
   _U.list([$Html.text("Diablo II Rune Words")]))]))]))]));
   var parseSearchKeywords = function (query) {
      return $String.isEmpty(query) ? $Maybe.Nothing : $Maybe.Just(A2($String.split,
      " ",
      query));
   };
   ...
   var renderAttributes = function (runeword) {
      ...
      _U.list([A2($Html.h6,
              ...
              "Sockets: ",
              $Basics.toString(runeword.sockets)))]))
              ,A2($Html.h6,
              _U.list([]),
              _U.list([$Html.text(A2($Basics._op["++"],
              "Ladder Only: ",
              $Basics.toString(runeword.ladderOnly)))]))
              ,A2($Html.h6,
              _U.list([]),
              _U.list([$Html.text(A2($Basics._op["++"],
              "Patch: ",
   ...
   var renderProperties = function (properties) {
      ...
      A2($List.map,
      function (p) {
         return A2($Html.li,_U.list([]),_U.list([$Html.text(p)]));
      },
      properties))]));
   };
   var renderRuneword = function (runeword) {
      return A2($Html.div,
      _U.list([$Html$Attributes.$class("box")]),
      _U.list([A2($Html.div,
              _U.list([$Html$Attributes.$class("content is-text-centered")]),
              _U.list([A2($Html.h3,
                      _U.list([$Html$Attributes.$class("title is-3")]),
                      _U.list([$Html.text(runeword.name)]))
                      ,A2($Html.p,
                      _U.list([$Html$Attributes.$class("subtitle is-5")
                      ...
                      _U.list([$Html.text(A2($String.join,
                      " | ",
                      A2($List.map,$Basics.toString,runeword.itemTypes)))]))]))
              ,A2($Html.div,
              _U.list([$Html$Attributes.$class("columns")]),
              _U.list([A2($Html.div,
                      _U.list([$Html$Attributes.$class("column is-4")]),
                      _U.list([renderAttributes(runeword)]))
                      ,A2($Html.div,
                      _U.list([$Html$Attributes.$class("column is-8")]),
   ...
   var KeywordSearch = function (a) {
      return {ctor: "KeywordSearch",_0: a};
   };
      ...
      _U.list([A2($Html.label,
              ...
              _U.list([A2($Html.input,
                      _U.list([$Html$Attributes.$class("input is-primary")
                              ...
                              $Html$Events.targetValue,
                              function (v) {
                                 return A2($Signal.message,address,KeywordSearch(v));
                              })]),
                      _U.list([]))
                      ,A2($Html.span,
                      _U.list([$Html$Attributes.$class("select")]),
